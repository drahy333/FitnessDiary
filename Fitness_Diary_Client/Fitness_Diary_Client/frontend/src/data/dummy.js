...

  {
    ...
    links: [
...

      {
        name: 'training',
        navigate: 'training',
        icon: <FontAwesomeIcon icon={faDumbbell} className="text-xl"/>
        ,
      },
      {
        name: 'performance',
  ...
  },
  {
    ...
    links: [
      ...
      // },
      {
        name: 'cardio',
        navigate: 'cardio',
        icon: <BiRun className="text-2xl" />,
      },
      {
        name: 'caloric expenditure',
        navigate: 'performance-cardio',
        icon: <AiOutlineStock className="text-xl"/>,
      },
    ],
  },
  {
    ...
    links: [
      ...
      // },
      {
        name: 'nutrition',
        navigate: 'food',
        icon: <FontAwesomeIcon icon={faUtensils} className="text-xl"/>,
      },
      {
        name: 'caloric intake',
        navigate: 'performance-food',
        icon: <AiOutlineStock className="text-xl"/>,
      },
    ],
  },
...
export const lineChartData = [
  [
    { x: new Date(2024, 3, 30), y: 21 },
    { x: new Date(2024, 4, 1), y: 24 },
    { x: new Date(2024, 4, 2), y: 36 },
    { x: new Date(2024, 4, 3), y: 38 },
    { x: new Date(2024, 4, 4), y: 54 },
    { x: new Date(2024, 4, 5), y: 57 },
    { x: new Date(2024, 4, 6), y: 70 },
    { x: new Date(2024, 4, 7), y: 75 }  // Added to extend to May 7th, 2024
  ],
  [
    { x: new Date(2024, 3, 30), y: 28 },
    { x: new Date(2024, 4, 1), y: 44 },
    { x: new Date(2024, 4, 2), y: 48 },
    { x: new Date(2024, 4, 3), y: 50 },
    { x: new Date(2024, 4, 4), y: 66 },
    { x: new Date(2024, 4, 5), y: 78 },
    { x: new Date(2024, 4, 6), y: 84 },
    { x: new Date(2024, 4, 7), y: 90 }  // Added to extend to May 7th, 2024
  ],

  [
    { x: new Date(2024, 3, 30), y: 10 },
    { x: new Date(2024, 4, 1), y: 20 },
    { x: new Date(2024, 4, 2), y: 30 },
    { x: new Date(2024, 4, 3), y: 39 },
    { x: new Date(2024, 4, 4), y: 50 },
    { x: new Date(2024, 4, 5), y: 70 },
    { x: new Date(2024, 4, 6), y: 100 },
    { x: new Date(2024, 4, 7), y: 110 }  // Added to extend to May 7th, 2024
  ],
];
